...
const DebugDataField_ParamType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ACTION', '2': 18},
    const {'1': 'WIDGET', '2': 19},
    const {'1': 'WIDGET_BUILDER', '2': 20},
    const {'1': 'API_RESPONSE', '2': 21},
    const {'1': 'CLOUD_FUNCTION_RESPONSE', '2': 22},
    const {'1': 'API_RESPONSE_STREAM', '2': 23},
  ],
};

/// Descriptor for `DebugDataField`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List debugDataFieldDescriptor = $convert.base64Decode('');
